...
const SupportPage: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 border-l-4 border-accent pl-4">Support & Feedback</h1>
      <div className="bg-secondary p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {subject === 'Missing Download Link' && (
             <div>
                <label htmlFor="contentTitle" className="block text-sm font-medium text-muted mb-2">
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full bg-accent text-white font-bold py-3 px-4 rounded-md hover:bg-blue-500 transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed"
            >
