...
// Filter out @-names, as they are handled by a generic regex part.
...
// Regex to match:
// 1. Any @-tag (e.g., @ClipmateMovies)
// 2. Any bracketed content (e.g., [TGx])
// 3. Any of the specific non-@ words from our blocklist (e.g., MovieWorldHub)
const NOISE_REGEX = new RegExp(`@[\w.-]+|\\[.*?\\]|\\b(${WORD_BLOCKLIST.join('|')})\\b`, 'gi');
