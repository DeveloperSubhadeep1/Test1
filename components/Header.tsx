      ...
      <div className="container">
        <div className="flex items-center h-16 gap-2 sm:gap-4">
          ...
          <div className="flex items-center flex-shrink-0">
            <button
              onClick={onMenuClick}
              className="group p-2 rounded-md text-light-muted dark:text-gray-400 hover:text-light-text dark:hover:text-white hover:bg-light-secondary dark:hover:bg-primary focus:outline-none focus:ring-2 focus:ring-inset focus:ring-light-accent dark:focus:ring-white"
              aria-label="Open navigation menu"
            >
              <MenuIcon className="h-6 w-6 transition-transform duration-300 group-hover:scale-110" />
            </button>
            
            <Link to="/" className="group flex-shrink-0 flex items-center space-x-2 text-light-text dark:text-white text-xl font-bold ml-1 sm:ml-2">
